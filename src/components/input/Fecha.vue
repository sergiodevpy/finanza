<template>
  <div style="max-width: 180px">
    <q-input outlined square v-model="storeActaDB.actaObjPage.fecha" label="Fecha">
      <template v-slot:append>
        <q-icon name="event" class="cursor-pointer">
          <q-popup-proxy cover transition-show="scale" transition-hide="scale">
            <q-date ref="selectorFecha" v-model="storeActaDB.actaObjPage.fecha" minimal mask="DD/MM/YYYY">
...
const {fecha} = storeToRefs(usePageStoreActaOfrenda())
